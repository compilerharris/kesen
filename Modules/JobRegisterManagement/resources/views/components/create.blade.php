    ...
    <div class="content" style="padding-top: 20px;margin-left: 10px">
        ...
        <x-adminlte-card style="background-color: #eaecef;" title="New Job Register" theme="info" icon="fas fa-lg fa-person">
            ...
            <form action="{{ route('jobregistermanagement.store') }}" method="POST">
                ...
                <div class="row pt-2">
                    ...
                    <div class="form-group col-md-1 no_estimate">
                        ...
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" name="t" id="t" checked>
                ...
                <button type="submit" id="jobRegisterSubmit" class="mt-3 btn btn-info" onClick="this.form.submit(); this.disabled=true; this.innerText='Creating…'; ">Submit</button>
