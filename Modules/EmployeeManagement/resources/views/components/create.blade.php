        ...
        <x-adminlte-card style="background-color: #eaecef;" title="New Employee" theme="info" icon="fas fa-lg fa-person">
            ...
            <form action="{{ route('employeemanagement.store') }}" method="POST">
                ...
                <div class="row pt-2">
                    ...
                    <x-adminlte-select2 name="language[]" :config="$config" id="language" fgroup-class="col-md-3" required value="{{ old('language') }}" label="Language" multiple :config="['closeOnSelect' => false]">
