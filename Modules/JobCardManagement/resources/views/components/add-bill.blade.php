    ...
    <div class="content" style="padding-top: 20px;margin-left: 10px">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item "><a href="/job-card-management?jobNo={{$job_no}}&cp=&document=&pm=&contactPerson=&from=&to=&status=">Add Bill for Job {{$job_no}}</a></li>
            </ol>
        </nav>
        ...
        <form action="{{ route('jobcardmanagement.bill.store',$job_id) }}" method="POST" >
            ...
            <div class="row pt-2">
                ...
                <x-adminlte-input name="bill_date"  placeholder="Bill Date"
                    ...
                    fgroup-class="col-md-2" value="{{ old('bill_no') }}" type='text' label="Bill Amount"/>
