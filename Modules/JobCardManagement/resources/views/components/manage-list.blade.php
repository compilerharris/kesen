                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row pt-2">
                                            ...
                                            {{-- billing status --}}
                                            <x-adminlte-select2 name="billingStatus" fgroup-class="col-md-2" value="{{old('billingStatus')}}" label="Billing Status">
        ...
        <div class="content" style="padding-top: 20px; margin-left: 10px">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="/job-card-management?jobNo={{$job_register->sr_no}}&cp=&document=&pm=&contactPerson=&from=&to=&status=">Job No {{$job_register->sr_no}}</a></li>
                </ol>
            </nav>
            @include('components.notification')
            <div class="card card-info" style="margin:10px">
