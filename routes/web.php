...
Route::get('/payment-report-preview/{writerId}/{paymentId}/{purpose}', [App\Http\Controllers\HomeController::class, 'generatePaymentReportPreview'])->name('report.payments.preview')->middleware('auth');
